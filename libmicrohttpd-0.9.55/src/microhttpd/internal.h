 ...
 */
#define MHD_PANIC(msg) do { mhd_panic (mhd_panic_cls, "A", __LINE__, msg); BUILTIN_NOT_REACHED; } while (0)
#else
/**
 * Trigger 'panic' action based on fatal errors.
 *
 * @param msg error message (const char *)
 */
#define MHD_PANIC(msg) do { mhd_panic (mhd_panic_cls, "A", __LINE__, NULL); BUILTIN_NOT_REACHED; } while (0)
#endif
